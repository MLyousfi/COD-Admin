...
const RouteNames = {
    ...
    statisticsSponsoring: '/statistics/sponsoring',
    statisticsAgents: '/statistics/agents',
    statisticsAgentsActivities: '/statistics/agents/activities',
    statisticsAgentscallCenter: '/statistics/agents/call-center',
    statisticsAgentsFollowup: '/statistics/agents/follow-up',
    invoices: '/invoices',
