                                                        ...
                                                        <li key={child.path} className="ml-6">
                                                            {child.children ? (
                                                                <>
                                                                    ...
                                                                    {expandedRoutes[child.path] && showSidebar && (
                                                                        <ul className="pl-4">
                                                                ...
                                                                >
                                                                    <motion.div
                                                                        ...
                                                                        transition={{
                                                                            ...
                                                                            damping: 15,
                                                                            bounce: 0.5,
                                                                        }} className={`flex justify-center text-[11px] items-center p-1 rounded-full ${pathMapWithNotif && pathMapWithNotif[child.path].notifNum !== 0 ? "bg-glb_red" : ""}  w-6 h-6 mr-3 text-white`} >
                                                                        {pathMapWithNotif && pathMapWithNotif[child.path].notifNum !== 0 ? pathMapWithNotif[child.path].notifNum : ''}
                                                                    </motion.div>
                                                                    {child.name}
                                                                </Link>
                                                            )}
