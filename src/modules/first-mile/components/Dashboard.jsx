...
import './datepicker.css'; // Ensure this import is present for dark mode
import { format } from 'date-fns';
import useOnClickOutside from 'use-onclickoutside';

// CallsCard component remains unchanged
const CallsCard = ({
  icon,
  iconColor,
  cardBg,
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center px-2 gap-2 md:px-6 mb-1">
        ...
        <div className="flex items-center space-x-2 order-1 md:order-2 ml-auto">
          ...
          <div className="relative">
            ...
            {/* Date Picker */}
            {showDatePicker && (
              <div ref={datePickerRef} className="absolute left-0 top-full z-10 mt-2">
                <DatePicker
                  selected={startDate}
                  ...
                  endDate={endDate}
                  selectsRange
                  inline // Render the calendar directly without an input
                />
              </div>
            )}
          </div>
          ...
          <div className="relative">
            <select
              className="p-2 border border-gray-700 dark:bg-black bg-transparent text-black dark:text-white rounded-full px-4 pr-8 appearance-none focus:outline-none"
